...
enum AppLocalizer {
    static func text(_ key: L10nKey, language: AppLanguage) -> String {
        ...
        case .zhHans:
            ...
            case .syncDailyMDLinks: return "同步 Daily 参考链接"
            ...
            case .sortByDomain: return "按域名排序"
        ...
        case .en:
            ...
            case .syncDailyMDLinks: return "Sync Daily Reference Links"
            ...
            case .sortByDomain: return "Sort by Domain"
